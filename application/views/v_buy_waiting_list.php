...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            req(system_config, '/Ajax/ajax_popup_list', {
                ...
                callback:function(rtn) {
                    if(rtn.result > 0){
                        ...
                        // 전환 수량
                        $('.coin').text(rtn.coin_amount + " <?=COIN;?>");
                        // 입금자
        ...
        $('.btn_save').on('click', function() {
            var buy_seq = $('.btn_save').data("seq");
            var state = $('.btn_save').data("state");
            ...
            var result = '';
            if ( state == 'C') {
                result = confirm('구매취소 후 취소가 불가능합니다. 구매취소하시겠습니까?');
            } else {
                result = confirm('구매승인 후 취소가 불가능합니다. 구매승인하시겠습니까?');
            }
            ...
            $(".buy_popup_content_body").addClass('none');
            $(".loading").removeClass('none');
            $(".buy_popup_content_footer").addClass("none");
            ...
            req(system_config, '/Ajax/ajax_buy_change', {
                type: 'POST',
                json: true,
                data: params,
                callback: function (rtn) {
                    if (rtn.result > 0) {
                        ...
                        $(location).attr('href', '/Main/buy_waiting_list');
                    } else {
                        alert(rtn.err);
                    }
                }
...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-header">구매 대기자 목록</div>
    ...
    <div class="buy_popup">
        <div class="buy_popup_content">
            ...
            <div class="loading none">
                ...
                <p style="font-size: 20px; padding-bottom: 15px;">WARNING!</p>
                <p>구매 승인 처리중입니다.</p>
                <p>승인 완료까지 약 1분의 시간이 소요될 수 있습니다.</p>
            </div>
            <div class="buy_popup_content_footer">
                <a class="btn btn-cancel btn_save cancel">취소처리</a>
                <a class="btn btn-normal btn_save" >구매승인</a>
            </div>
        </div>
    </div>
</div>
