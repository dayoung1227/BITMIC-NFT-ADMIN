...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-header">Receive List</div>
                        ...
                        <div class="alignR">
                            <label class="clabel01">
                                <select name="search_type" class="form-control form-control-sm cinput01 search_type col-4" id="btn_change">
                                    <option value="search_type_a">받은사람</option>
                                    <option value="search_type_b">보낸사람</option>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0 table_s1 dataTable" id="userdata" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th class="board_order" data-order="board_order_3">전송보낸 일시</th>
                        </tr>
                        </thead>
                        <tbody>
                        <? foreach ($list_data as $rows){
                            ...
                            ?>
                            <tr>
                                <td class="responsive-sm"><?=$rows["seq"];?></td>
                                <td>
                                    <?=substr($rows["txid"], 0, 10);?>...
                                </td>
                                <td class="responsive-sm"><?=$rows["category"];?></td>
                                <td class="gotouserdetail responsive-sm <?php echo $v_d_color;?>" data-seq="<?=$sender_seq;?>"><?=$rows["sunick"];?></td>
                                <td class="gotouserdetail responsive-sm <?php echo $v_w_color;?>" data-seq="<?=$receiver_seq;?>"><?=$rows["runick"];?></td>
                                <td class="alignR responsive-sm"><?=$rows["amount"]." ".COIN;?></td>
